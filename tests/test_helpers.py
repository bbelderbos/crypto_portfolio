...
from portfolio.helpers.chart import (
...
@pytest.mark.vcr()
def test_coin_data_all_coins(cg):
...
@pytest.mark.vcr()
def test_single_coin_data(coin, expected, cg):
...
@pytest.mark.vcr()
def test_single_coin_exchanges(cg):
