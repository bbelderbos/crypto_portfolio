...
class PortfolioHoldings(models.Model):
    coin_ticker = models.CharField(max_length=100, null=False, default='')
    ...
    type = models.CharField(max_length=10, null=False, blank=False, default='Click to choose Buy or Sell')
